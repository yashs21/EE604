...
def solution(image_path):
    ...
    for x in range(height):
        ...
        if (red==0 and blue==0 and green ==0) or (red==255 and blue==255 and green ==255) or (red==0 and blue==255 and green ==0):
            continue
        if (red==0 and blue==0 and green==128) or (red==255 and blue==153 and green ==51):
            vertical=1 
